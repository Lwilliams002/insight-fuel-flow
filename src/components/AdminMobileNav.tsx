...
export function AdminMobileNav() {
  ...
  return (
    <>
      ...
      {/* Bottom Navigation - Enhanced for mobile PWA */}
        ...
        <div className="flex items-center justify-around h-[72px] px-2">
          {navItems.slice(0, 5).map((item) => (
            <Link
              ...
              to={item.href}
              className={cn(
                'flex flex-col items-center justify-center gap-1 min-w-[60px] py-2 px-3 rounded-xl transition-all active:scale-95',
                isActive(item.href)
